...
class VideoPlayer extends React.Component {
    ...
    speedLongTouch = (evt) => {
        ...
        var speedTouchWidth = this.state.width / 4;
        if (speedStartX >= this.state.width - speedTouchWidth) {

            this.setState({
                videoRate: this.speedFastValue,
                speedTouch: true,
            }, () => {
                this.rightSpeedRef.setNativeProps({
                    style: {
                        opacity: 1,
                    },
                });
        ...
        if (speedStartX <= speedTouchWidth) {

            this.isSolTouch = true;
            this.setState({
                speedTouch: true,
            });
            this.nowCurrentTime && this.player.seek(this.nowCurrentTime - 5);
            this.sloSpeedTime = setInterval(() => {

                this.nowCurrentTime && this.player.seek(this.nowCurrentTime - 5);
            }, 500);
            this.leftSpeedRef.setNativeProps({
                style: {
                    opacity: 1,
                },
            });
    ...
    speedLongTouchOut = (evt) => {
        ...
        var speedTouchWidth = this.state.width / 4;
        if (speedStartX <= speedTouchWidth) {
            this.sloSpeedTime && clearInterval(this.sloSpeedTime);
            this.isSolTouch = false;
            this.leftSpeedRef.setNativeProps({
                style: {
                    opacity: 0,
                },
    ...
    componentWillMount () {
        ...
        this._panResponder = PanResponder.create({
            ...
            onPanResponderMove: (evt, gestureState) => {
                ...
                if (this.LockRef && this.LockRef.state.lock || this.speedTouch) return;//锁定控件时 禁用手势
    ...
    showLockAndCont = () => {
        ...
        const animaFun = () => {
            this.hide.stop();
            this.AnimatedOp.stop();
            this.fastHide && this.fastHide.stop();
        };
        if (this.LockRef && !this.LockRef.state.lock) {
            this.AnimatedOp.start(() => {
                this.setState({ ...GSHOWSTATE });
                animaFun();
            }); // 开始执行动画
        } else {
            !this.LockRef
                ...
                :
                this.AnimatedOp.start(() => {
                    this.setState({ showLockCont: true, showChangeList: false });
                    animaFun();
                }); // 开始执行动画
        }
    };
                ...
                <View ref={ ref => this.videoBox = ref } style={ { backgroundColor: '#000', position: 'relative' } }>
                    ...
                    <View style={ {} }>
                        ...
                        <View  { ...this._panResponder.panHandlers }
                               style={ { height: stateHeight, width: stateWidth } }
                               activeOpacity={ 1 }
                        >
                            <TouchableOpacity
                                activeOpacity={ 1 }
                            ...
                            >
                                ...
                                <View style={ {
                                    ...
                                    <View ref={ (e) => this.leftSpeedRef = e } style={ {
                                        opacity: 0,
                                        width: stateHeight * 2,
                                        backgroundColor: 'rgba(0,0,0,0.5)',
                                        borderRadius: stateHeight * 2,
                                        right: stateHeight * 2 - speedLoToWidth,
                                        height: stateHeight * 2,
                                        top: -stateHeight / 2,
                                    } }></View>
                                    <View ref={ (e) => this.rightSpeedRef = e } style={ {
                                        opacity: 0,
                                        width: stateHeight * 2,
                                        backgroundColor: 'rgba(0,0,0,0.5)',
                                        borderRadius: stateHeight * 2,
                                        right: stateHeight * 2 - stateWidth + speedLoToWidth,
                                        height: stateHeight * 2,
                                        top: -stateHeight / 2,
                                    } }></View>
                                    {
                                        ...
                                        >
                                            ...
                                            >
                                                <AnFastSvg
                                                    isSolTouch={ this.isSolTouch }
                                                    videoRate={ videoRate }
                                                    solText={ this.props.solText }
                                                    fastText={ this.props.fastText }
                                                />
                        ...
                        { this.state.showConts ?
                            ...
                            >
                                {/* 阴影 */ }
                                <LinearGradient colors={ ['rgba(0,0,0,0.4)', 'rgba(0,0,0,0.1)', 'rgba(0,0,0,0)'] }
                                                style={ {
                                ...
                                >
                                    ...
                                    <Text
                                        style={ {
                                            ...
                                            fontSize: 15,
                                            paddingLeft: 10,
                                            maxWidth: smallP ? width / 3 : height / 3, ...this.props.backVideoNameStyle,
                                        } }
                                        numberOfLines={ 1 }
                                    >
                                ...
                                <View style={ {
                                    ...
                                    >
                                        { this.props.storeComponent ? this.props.storeComponent() : <SvgVideoScang
                                            height="20" width="20" /> }
                                    </TouchableOpacity>
                                    <TouchableOpacity style={ { padding: 8, marginLeft: 1 } }
                                                      onPress={ this.props.onMoreFun && this.props.onMoreFun() }
                                    >
                                        { this.props.moreSetting ? this.props.moreSetting() : <SvgVideoSetting
                                            height="20" width="20" /> }
                                    </TouchableOpacity>
                                </View>
                            </Animated.View>
                                    ...
                                    <View style={ { flexDirection: 'row', flexWrap: 'nowrap' } }>
                                        {/* 播放暂停 */ }
                                        {
                                            !this.props.continuous ? (this.state.paused
                                                        ?
                                                        <TouchableOpacity activeOpacity={ 1 } style={ s.touchs }
                                                                          onPress={ () => {
                                                                              if (!showOpenVip) {
                                        ...
                                        <View style={ {
                                            ...
                                            <View style={ { flexDirection: 'row', flex: 1 } }>
                                                    ...
                                                    this.props.continuous && (this.state.paused
                                                            ...
                                                            <TouchableOpacity activeOpacity={ 1 } style={ {
                                                                ...
                                                                zIndex: 999,
                                                                              ...
                                                                              onPress={ () => { !showOpenVip && this.setState({ paused: true }); } }>
                                                                <SvgVideoStop height="20" width="20" />
                                                            </TouchableOpacity>
                                                    )
                                                }
                                                {
                                                    ...
                                                    >
                                                        <SvgVideoNextBtn height="20" width="22"
                                                                         fill={ this.props.nextBtnFun ? '#ffffff' : '#626262' } />
                                                    </TouchableOpacity>
                                                }
                                            </View>
                                            <View
                    ...
                    {
                        /* loading */
                        <Loading { ...this.state } spin={ spin } loadingText={ this.props.loadingText }
                                 loadingIcon={ this.props.loadingIcon } />
                    }
                    {
                        this.adminPaused && this.state.paused &&
                        <TipsPaused { ...this.state } pausedTipText={ this.props.pausedTipText } />
                    }
